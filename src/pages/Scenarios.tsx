        ...
        <div className="animate-in fade-in duration-700">
            <section className="px-4 py-20 max-w-6xl mx-auto">
                <div className="mb-16">
                    ...
                    <p className="text-[#606e8a] dark:text-gray-400 text-lg font-medium max-w-2xl leading-relaxed">
            ...
            <section className="px-4 py-20 bg-blue-600 rounded-[2rem] mx-4 mb-20 text-white text-center overflow-hidden relative">
                <div className="absolute inset-0 opacity-10 bg-[radial-gradient(#fff_1px,transparent_1px)] bg-[size:20px_20px]"></div>
                <div className="relative z-10 max-w-2xl mx-auto">
                    <h2 className="text-3xl font-black mb-6">Have a scenario in mind?</h2>
                    ...
                    <button
                        ...
                        className="bg-white text-blue-600 px-8 py-4 rounded-xl font-bold text-lg shadow-xl shadow-blue-900/40 hover:scale-[1.05] transition-all"
                    >
